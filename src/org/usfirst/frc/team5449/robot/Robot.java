...
import org.usfirst.frc.team5449.robot.commandGroup.Go_Straight;
...
import org.usfirst.frc.team5449.robot.commandGroup.New_Auto_Pos3_L_SC;
import org.usfirst.frc.team5449.robot.commandGroup.New_Auto_Pos3_R_SC;
...
import Calibration.CB_ultrasonic;
...
public class Robot extends TimedRobot {
	...
	// private static SendableChooser<double[]> Field_pos_chooser = new
	// SendableChooser();
	...
	public void robotInit() {
		...
		Autonomous_target.addObject("Scale_Right", new int[] { 5 });
		Autonomous_target.addDefault("Go_Straight", new int[] { 6 });
