...
import org.usfirst.frc.team5449.robot.command.LifterToDown_Slow;
...
/**
 * OI Class: Define sensors and controls systems here Scheduler will search here
 */
public class OI {
	...
	public JoystickButton Lifter_to_down_slow = new JoystickButton(stick2, 9);
	...
	public OI() {
		...
		Lifter_to_down_slow.whenPressed(new LifterToDown_Slow());
	}
