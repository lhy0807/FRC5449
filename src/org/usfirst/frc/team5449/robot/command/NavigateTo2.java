 ...
 */
public class NavigateTo2 extends Command {
	double[] t = {0,0};	
	...
	public NavigateTo2(double[] TargetPos) {
    	// Use requires() here to declare subsystem dependencies
        requires(Robot.chassis);
		this.TargetPos = TargetPos;
        this.Stop = true;
    }
	public NavigateTo2(double[] TargetPos,boolean Stop)
	{
		requires(Robot.chassis);
		this.TargetPos = TargetPos;
		this.Stop = Stop;
    ...
    private void VectorUpdate(){
    	...
    	this.Position[0] = Robot.e1.get(Angle_d)[0] * 0.001;
    	this.Position[1] = Robot.e1.get(Angle_d)[1] * 0.001;
